...
data_file <- "Meta-analysis spreadsheet demographics to AI 221202DB.xlsx"

# Here you set the name for the tables and figures produced (without file ending)
files_out_name <- "22-demographics"
